		...
		<div class="col-lg-3"></div>
			<div class="col-lg-6">
				<div class="jumbotron" style="margin-top: 20px">
						...
						<form class="form-horizontal" action="action.php" method="post" name="add_admin" onsubmit="return(validateForm());">
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-2">
									<button type="Submit" class="btn btn-primary form-control" value="<?php if($e){echo"Edit Admin";}else{echo"Add Admin";}?>" name="action">Submit
									</button>
								</div>
							</div>
						</form>
			...
			<table border="3px" width= "50%" height= "50%" align="center">
				 <tr>
						<td colspan= "9" align= "center" style="background-color: lightblue"><strong> Admin Table </strong></td>
				 </tr>
				 <tr> 
						<td align="center"><strong> SL No </strong></td> <td align="center"><strong> Name </strong></td> <td align="center"><strong> User ID </strong></td> <td align="center"><strong> Gender </strong></td> <td align="center"><strong> Contact </strong></td> <td align="center"><strong> Email </strong></td> <td align="center"><strong> Address </strong></td><td colspan="2"></td>
				 </tr>
					...
					<?php $i++;} ?>
						...
						<script language="Javascript">
						 function delete_user(id){
											...
											if (msg){
													 window.location="add_admin.php?did="+id;  
													}   
										 }
						</script>
