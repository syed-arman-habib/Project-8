...
<?php  error_reporting(E_ALL & ~E_NOTICE); ?>
		...
		<div class="col-lg-3"></div>
			<div class="col-lg-6">
				<div class="jumbotron" style="margin-top: 20px">
						...
						<form class="form-horizontal" action="action.php" method="post" name="add_student" onsubmit="return(validateForm());">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
													<select class="form-control" name="program" value="<?php if($e){echo $edit['program'];}else{echo "";}?>">
														<option value = "0"> Select </option>
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-2">
									<button type="Submit" class="btn btn-primary form-control" value="<?php if($e){echo"Edit Student";}else{echo"Add Student";}?>" name="action">Submit
									</button>
								</div>
							</div>
				   </form>
			...
			<table border="3px" width= "50%" height= "50%" align="center">
				 <tr>
						<td colspan= "11" align= "center" style="background-color: lightblue"><strong> Student Table </strong></td>
				 </tr>
				 
				 <tr>
						<td align="center"><strong> Sl No </strong></td> <td align="center"><strong> Name </strong></td> <td align="center"><strong> User ID </strong></td> <td align="center"><strong> Gender </strong></td> <td align="center"><strong> Contact </strong></td> <td align="center"><strong> Email </strong></td> <td align="center"><strong> Address </strong></td> <td align="center"><strong> School </strong></td><td align="center"><strong> Program </strong></td><td colspan="2"></td>
				 </tr>
	...
	<div id="bac_IT">
		<table border="0" height="100px" width="1300px" align="center">
			...
			<tr>
				<td colspan="5" align="center"><font color="white"><br><br><br>© Copyright 2016 BAC International. All rights reserved </font>
				</td>
			</tr>
		</table>
	</div>
